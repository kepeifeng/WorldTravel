...
-(void)insertData{
    ...
    [book setValue:@"Core Data Programming" forKey:@"name"];
...
//    [failedBankInfo setValue:@"Testland" forKey:@"state"];
    ...
    [author setValue:@"Kent" forKey:@"name"];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.aroh.CoreDataPlayground" in the application's documents directory.
